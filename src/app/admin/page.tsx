...
export default function AdminPage() {
  ...
  return (
    <main className="mx-auto max-w-5xl px-4 py-10 sm:px-6">
      ...
      {state.kind === "denied" && (
        <div className="rounded-lg border rule-control bg-slate-50 p-6">
              ...
              {state.profiles.map((p) => {
                ...
                return (
                  ...
                  >
                    ...
                    {comps.length > 0 && (
                      <ul className="mt-2 space-y-1 border-t rule-hairline pt-2">
                        {comps.map((c) => {
                    ...
                    {dp && (
                      <div className="mt-2 border-t rule-hairline pt-2 text-sm">
