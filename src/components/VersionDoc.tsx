  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      ...
      <main className="mx-auto max-w-3xl px-4 pb-24 pt-16" style={branding}>
        ...
        <article className="doc-prose mt-12 border-t rule-hairline pt-10 text-[1.05rem] text-slate-800">
          {items.map((it) => (
        ...
        <div className="mt-10 flex flex-col gap-2 border-t rule-hairline pt-6 text-sm text-slate-500">
          <a
            href={REPO_V6_URL}
            target="_blank"
