...
export function ComposerEntete({
  ...
  return (
        <header className="mb-8">
          ...
          <div className="doc-measure doc-titre-boite border-b rule-hairline pb-6">
            ...
            <input
              ...
              className="doc-titre mt-1 w-full rounded-sm border-0 border-b border-transparent bg-transparent font-serif font-semibold text-slate-900 outline-none transition placeholder:text-slate-400 hover:rule-control focus:rule-focus"
            />
